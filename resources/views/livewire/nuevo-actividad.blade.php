<div>
    <section class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-col px-5 py-7 justify-center items-center">
            <div class="w-full flex flex-col mb-2 items-center text-center">
                ...
                <div class="grid grid-cols-3 gap-4 w-full justify-center items-end">

                    <div class="{{ $claseInput }}">
                        <label for="nombre" class="leading-7 text-sm mt-2 mb-8 text-gray-600">Nombre</label>
                    ...
                    <div class="{{ $claseInput }}">
                        <label for="historia_usuarios_id" class="text-md mt-2 text-gray-500 mb-8 w-full">Historia de usuario</label>
                    ...
                    <div class="{{ $claseInput }}">
                        <label for="proceso_id" class="text-md mt-2 text-gray-500 mb-8 w-full">Proceso</label>
                ...
                <div class="relative my-6 p-1 lg:w-full w-full md:w-full text-center">
