        ...
        <div class="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
            <div class="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
                ...
                <div class="flex flex-wrap w-full justify-center items-end">
                    ...
                    <div class="{{ $claseInput }}">
                        <label for="tipo_solicitud_id" class="text-md mt-2 text-gray-500 mb-8 w-full">{{$El_Label}}</label>

                        <select wire:model="tipo_solicitud_id" id="tipo_solicitud_id" 
                            class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <option value="-1" selected>Seleccione...</option>
                            @foreach($tipo_solicitud as $i => $gen)
